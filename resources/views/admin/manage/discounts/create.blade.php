                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="discountDescription" name="description" required
                                    placeholder="Discount Description" rows="4"></textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <img class="d-flex br-18 mr-3"
                                            src="https://bigvsg.com/wp-content/uploads/2021/12/WhatsApp-Image-2021-12-28-at-11.47.58.jpeg"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="minOrderProductVoucher"
                                        name="minOrderProductVoucher" placeholder="Minimum Order" min="0" value="0">
                                </div>
                            </div>
