        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col align-self-center">
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Edit Vendor</h4>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted active" aria-current="page">Edit Vendor</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <form action="{{ route('admin.vendor.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="vendorName" name="name" required
                                        value="{{ $vendor->name }}" placeholder="Vendor Name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select" id="vendorLocation" name="location">
                                        @foreach ($locations as $vendorLocation)
                                            <option value="{{ $vendorLocation->id }}" @selected($vendorLocation->id == $vendor->location_id)>
                                                {{ $vendorLocation->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="vendorPhoto">{{ $vendor->photo }}</label>
                                        </div>
                                    </div>
                                </div>
