            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9 d-flex gap-15x justify-content-end">
                            <button class="btn btn-primary d-flex gap-15x align-items-center pr-4 pl-4 pb-2 pt-2"><img
                                    src="{{ asset('assets/images/whatsapp.svg') }}" width="24"
                                    height="24" />Vendor</button>
                            <button class="btn btn-primary d-flex gap-15x align-items-center pr-4 pl-4 pb-2 pt-2"><i
                                    data-feather="mail" class="feather-icon"></i>Vendor</button>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <p class="m-0">{{ date('d, F Y', strtotime($transaction->created_at)) }} |
                                    ...
                                    <li class="media align-items-center mt-3 mb-3 justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <h5 class="mt-0 mb-1"><b>{{ $cart->product_variation->product->name }}</b>
                                                </h5>
                                    ...
                                    @foreach ($transaction->transaction_discounts as $discount)
                                        <div class="col-3 pl-1 pr-1 pb-2">
                                            <div class="bg-success p-3 br-18">
                                                <h5 class="card-title text-white">{{ $discount->discount->name }}</h5>
                                                <h6 class="card-text text-white">{{ $discount->discount->description }}
                                                </h6>
                                            </div>
                                        </div>
                                    @endforeach
