...
<body>
    <div class="container">
        <div class="mt-5 d-flex justify-content-between">
            <a href="{{ route('home') }}" class="btn btn-outline-secondary"><span><i
                        data-feather="arrow-left"></i></span> Back</a>
                ...
                <div class="col-sm-10 d-flex align-items-center">
                    <div class="progress w-100">
                        <div class="progress-bar" role="progressbar" aria-label="Default striped example"
                            style="width: calc({{ auth()->user()->tier_points }}/10000 * 100%)"
                            aria-valuenow="{{ auth()->user()->tier_points }}" aria-valuemin="0" aria-valuemax="10000">
                        </div>
                    </div>
                </div>
            </div>
