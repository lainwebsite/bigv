						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								@auth
									...
									<!-- Transaction History -->
									<div>
										<a href="{{ route('user.transaction.index') }}" style="width: 150px; height: 60px;">
						...
						<div class="row">
							@foreach($products as $product)
								...
								<div class="col-md-4 col-xs-6">
									<div class="product">
										<div class="product-img">
											<img src="{{ $product->images[0]->link }}" style="height: 250px" alt="">
										...
										<div class="product-body">
											...
											<h4 class="product-price">${{ $product->variations[0]->price }} <del class="product-old-price">$0.00</del></h4>
