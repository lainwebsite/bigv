...
<body class="body" style="overflow-x: hidden; width: 100vw !important;">
                            ...
                            <div class="input">
                                ...
                                <div data-w-id="322b334f-cb7d-a0a4-b9ca-b6b874d7aa26" class="input__field-wrapper">
                                    <input type="text" class="input__field w-input" maxlength="256"
                                        style="background-color: #ffffff !important;" name="keyword" data-name="Search"
                    ...
                    <div class="nav-link-wrapper">
                        <div style="display: flex; justify-content:space-between; height: 100%;">
                            @auth
                                ...
                                <a href="#" data-w-id="33ebaa1d-c890-4ed1-df4b-2410c2296afb"
                                    class="nav-link w-nav-link"
                                    style="font-size: 24px; margin:0 !important; display: flex; align-items:center; height: 100%; padding:20px 10px;"><i
        ...
        <div class="hero">
            ...
            <div class="hero-center">
                ...
                <div class="heading-xlarge text-align-center ea-top">By <span
                        class="text-color-orange">Comunity</span><br />with <span
                        class="text-color-orange">Love</span></div>
                <div class="text-align-center text-color-grey ea-bottom">At vero eos et accusamus et iusto odio
                    dignissimos
                ...
                <div class="hero-button ea-bottom"><a href="#" class="button w-button">Order Now</a><a
        ...
        <div class="todays-pick-promo-container">
            ...
            <div class="promo-div">
                <div id="w-node-_5eb6a600-3317-8d0d-76be-b3ed7dd852c4-92c73a6a"><img
                        src="{{ asset('assets/62fc7f0235498a4fb875692e_Rectangle 37.webp') }}" loading="lazy"
                        ...
                        srcset="{{ asset('assets/62fc7f0235498a4fb875692e_Rectangle%2037.webp') }}" alt=""
                        class="ea-left" /></div>
                <div id="w-node-_5eb6a600-3317-8d0d-76be-b3ed7dd852c6-92c73a6a" class="div-block-2"><img
                        src="{{ asset('assets/62fc7f0235498a5404756931_Rectangle 38.webp') }}" loading="lazy"
                ...
                <div id="w-node-_5eb6a600-3317-8d0d-76be-b3ed7dd852c8-92c73a6a" class="div-block-2"><img
                        src="{{ asset('assets/62fc7f0235498a3850756933_Rectangle 39.webp') }}" loading="lazy"
                ...
                @for ($i = 0; $i < 5; $i++)
                    <div class="product-card">
                        <div class="text-rich-text text-size-small text-color-orange">Cak Har</div><img
                            src="{{ asset('assets/63216732fa4234229ca16b24_image 34.webp') }}" loading="lazy"
                        ...
                        <div class="product-card-low-div">
                            ...
                            <div id="w-node-ef3a66a8-3bec-7b1f-2fee-5afd7fd6b61e-92c73a6a"
                                class="sale-price text-color-light-grey">
                                $24.00</div>
                ...
                @for ($i = 0; $i < 10; $i++)
                    <div class="product-card">
                        ...
                        <div class="product-card-low-div">
                            ...
                            <div id="w-node-_23416fdd-358f-ec0e-a92a-591751aa8e04-92c73a6a"
                                class="sale-price text-color-light-grey">
                                $24.00</div>
                            <div class="text-rich-text text-color-orange text-weight-bold">$12.00</div>
                        </div>
    ...
    <div class="soft-sell-section">
        <div class="soft-sell-left d-flex">
            ...
            <div class="text-size-regular text-color-grey ea-left character-limit">Lorem ipsum dolor sit amet,
                consectetur
                adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</div><a
    ...
    <div class="value-section"><img src="{{ asset('assets/633652c3764cda2b58895a36_Intersect.svg') }}"
        ...
        <div class="value-right">
            ...
            <div class="text-size-regular text-color-grey ea-right">&quot;Lorem ipsum dolor sit amet, consectetur
                adipiscing
        ...
        <div class="footer-top text-color-white relative">
            ...
            <div class="flex align-vertical ea-right">
                <div class="flex flex-vertical left-align margin-small">
                    <h4>Contact Us</h4><a href="#" class="text-color-white text-style-link">Instagram</a><a
                        href="#" class="text-color-white text-style-link">Facebook</a><a href="#"
