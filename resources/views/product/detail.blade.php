        ...
        <div class="content-col col--width-50" id="productDetail">
            <div class="div-block-5 ea-up">
                <div class="product-info">
                    ...
                    <h2 class="product-name heading-2 text-color-grey margin-vertical margin-xsmall">{{ count($product->variations) > 0 ? ($product->variations[0]->name == "novariation" ? $product->name : $product->variations[0]->name) : $product->name }}</h2>
                    ...
                    @if ($product->variations[0]->name == "novariation")
                        <h3 class="heading-3 margin-vertical margin-xsmall">${{ $product->variations[0]->price }}</h3>
                        <div class="div-line"></div>
                    @else
                        <h3 class="heading-3 margin-vertical margin-xsmall">${{ $minProductPrice }}</h3>
                        <h3 class="heading-3 margin-vertical margin-xsmall" style="width: auto;">-</h3>
                        <h3 class="heading-3 margin-vertical margin-xsmall">${{ $maxProductPrice }}</h3>
                        <div class="div-line"></div>
                        <h5 class="heading-4 mb-2">Variant Name</h5>
                        <div class="flex flex-wrap mb-3">
                            @foreach($product->variations as $productVariation) 
                                <button class="btn-variation button-secondary-copy w-button">{{ $productVariation->name }}</button>
                            @endforeach
                        </div>
                    @endif
